...
13. Wait for the change to propagate, it usually takes a few minutes and you can follow along as shown below (it is enough that some of the commands return the registered value)
